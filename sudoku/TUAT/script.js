...
const initSudoku = () => {
    //clear last sudoku puzzle from board
    clearSudoku();
    resetBg();
...
const loadSudoku = () => {
    ...
    for (let i = 0; i < Math.pow(CONSTANT.GRID_SIZE, 2); i++) {
        ...
        cells.innerHTML = su_answer[row][col] !== 0 ? su_answer[row][col] : '';
...
document.querySelector('#btn-new-game2').addEventListener('click', () => {
    returnStartScreen();
});

// const new2 = document.querySelector('#btn-new-game2');
// new2.addEventListener('click', () => {
//     new2.classList.add('active');
// })
//end pause screen
